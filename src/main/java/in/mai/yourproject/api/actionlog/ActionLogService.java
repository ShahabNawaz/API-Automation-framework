...
public class ActionLogService {
    ...
    public ActionLogResponse getActionLogs(ITestContext context) {
        String url = config.getKwala_frontend_url() + String.format(ApiEndPoints.ACTION_LOG_VIEW, config.getDeployerAddress());
